...
typography:
  # — reading ramp — (Korean-first stack; Noto Sans CJK KR carries Korean glyphs, Barlow used for Latin/digits)
  body:    { fontFamily: "\"NotoSansKR\", sans-serif", cqw: 1.3, weight: 400, lineHeight: 1.55 }
  lead:    { fontFamily: "\"NotoSansKR\", sans-serif", cqw: 1.7, weight: 500, lineHeight: 1.5 }
  caption: { fontFamily: "\"NotoSansKR\", sans-serif", cqw: 1.0, weight: 400, lineHeight: 1.5 }
  label:   { fontFamily: "\"NotoSansKR\", monospace", cqw: 0.8, weight: 500, tracking: "0.14em", upper: true }
  # — display / hero ramp — Korean rendered in Noto Sans CJK KR at strong weights
  h3:      { fontFamily: "\"NotoSansKR\", sans-serif", cqw: 2.8, weight: 700, lineHeight: 1.25 }
  quote-text:{ fontFamily: "\"NotoSansKR\", sans-serif", cqw: 3.6, weight: 700, lineHeight: 1.25, tracking: "-0.01em" }
  h2:      { fontFamily: "\"NotoSansKR\", sans-serif", cqw: 4.2, weight: 700, lineHeight: 1.2, tracking: "-0.02em" }
  stat-value:{ fontFamily: "\"NotoSansKR\", sans-serif", cqw: 6.5, weight: 900, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "\"NotoSansKR\", sans-serif", cqw: 6.5, weight: 900, lineHeight: 1.1, tracking: "-0.03em" }
  fadelist-item:{ fontFamily: "\"NotoSansKR\", sans-serif", cqw: 6.5, weight: 900, lineHeight: 1.1, tracking: "-0.03em" }
  quote-mark:{ fontFamily: "\"NotoSansKR\", sans-serif", cqw: 10.0, weight: 900, lineHeight: 0.6 }
  fadelist-title:{ fontFamily: "\"NotoSansKR\", sans-serif", cqw: 8.5, weight: 900, lineHeight: 1.05, tracking: "-0.03em" }
  display: { fontFamily: "\"NotoSansKR\", sans-serif", cqw: 9.5, weight: 900, lineHeight: 1.02, tracking: "-0.03em" }
